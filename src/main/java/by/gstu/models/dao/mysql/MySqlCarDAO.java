...
class MySqlCarDAO implements CarDAO {
    ...
    public static class MySqlTransmissionDAO implements CarDAO.CarEntityDAO<Transmission> {
        ...
        public Collection<Transmission> readAll() {
            ...
            try {
                ...
                ResultSet resultSet = statement.executeQuery();
                Collection<Transmission> transmissions = new ArrayList<>();
                while (resultSet.next()) {
                    int id = resultSet.getInt("id");
    ...
    public static class MySqlFuelTypeDAO implements CarDAO.CarEntityDAO<FuelType> {
        ...
        public Collection<FuelType> readAll() {
            ...
            try {
                ...
                ResultSet resultSet = statement.executeQuery();
                Collection<FuelType> fuelTypes = new ArrayList<>();
                while (resultSet.next()) {
                    int id = resultSet.getInt("id");
                    String name = resultSet.getString("name");

                    fuelTypes.add(new FuelType(id, name));
                }
                return fuelTypes;
            } catch (SQLException | InterruptedException e) {
                logger.error(e.getMessage(), e);
